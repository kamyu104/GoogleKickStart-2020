...
|D| [Golden Stone](https://codingcompetitions.withgoogle.com/kickstart/round/000000000019ff47/00000000003bef29)| [Python](./Round%20E/golden_stone.py) | _O((N * S + M * S + R * N) * log(N * S))_ | _O(N * S + N * R + M)_ | Hard | | Dijkstra's Algorithm |
