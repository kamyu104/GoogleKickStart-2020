...
|C| [Perfect Subarray](https://codingcompetitions.withgoogle.com/kickstart/round/000000000019ff43/00000000003381cb)| [PyPy](./Round%20C/perfect_subarray.py)| _O(N * sqrt(N * MAX_A))_ | _O(N * MAX_A)_ | Easy | | Math, Hash Table |
