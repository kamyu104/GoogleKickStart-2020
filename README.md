...
|D| [Merge Cards](https://codingcompetitions.withgoogle.com/kickstart/round/00000000001a0069/0000000000415054)| [Python](./Round%20G/merge_cards.py) [Python](./Round%20G/merge_cards2.py) |  ctor: _O(MAX_N^2)<br>runtime: _O(N)_ | ctor: _O(MAX_N^2)<br>runtime: _O(1)_| Medium | | Math, DP, Precompute |
